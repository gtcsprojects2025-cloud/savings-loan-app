      ...
      <div className="w-full max-w-lg bg-white border border-gray-200 shadow-2xl rounded-xl p-8 sm:p-10">
        ...
        <div className="mt-6 text-sm text-center text-gray-600 space-y-2">
          <p>
            ...
            <a href="/register/registrationform" className="text-brandBlue font-medium hover:underline">
              Register
            </a>
          </p>
          <p>
            <a href="/forgotpasswordpage" className="text-brandOrange font-medium hover:underline">
              Forgot password?
            </a>
          </p>
        </div>
