  ...
  return (
    <div className="min-h-screen w-full px-5 lg:px-0 bg-gray-50 flex items-center justify-center font-sans">
      <div className="w-full max-w-4xl bg-white border border-gray-200 shadow-2xl rounded-xl p-8 sm:p-10 my-8">
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 backdrop-blur-sm transition-opacity duration-300">
            <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-sm w-full text-center transform transition-all duration-300 scale-100">
              <div className="flex justify-center items-center">
                <Checkmark className="h-20 w-20 transform scale-100 checkmark-animation" />
              </div>
              <p className="text-2xl font-bold text-orange-700 mt-6">Form submitted successfully!</p>
      ...
      <style>{`
        ...
        .checkmark-circle {
          stroke-dasharray: 137.5;
          stroke-dashoffset: 0;
          animation: stroke-check 0.6s ease-out 0.4s backwards;
        ...
        .checkmark-check {
          ...
          animation: stroke-check 0.3s ease-out 0.9s forwards;
        }
